...
FROM (VALUES
    -- Massage toàn thân
    ('MS-001', 'Massage thư giãn toàn thân 60p',  'Massage thư giãn toàn thân kỹ thuật cơ bản',   250000, 60),
    ('MS-002', 'Massage thư giãn toàn thân 90p',  'Massage thư giãn toàn thân 90 phút',            350000, 90),
    ('MS-003', 'Massage aroma toàn thân',          'Massage bằng tinh dầu thiên nhiên 60 phút',     350000, 60),
    ('MS-004', 'Massage đá nóng toàn thân',        'Massage kết hợp đá bazan nóng 75 phút',         450000, 75),
    ('MS-005', 'Massage dầu nóng toàn thân',       'Massage với dầu nóng giảm đau nhức 60 phút',    300000, 60),
    -- Massage chân phản xạ
    ('MS-006', 'Massage chân phản xạ 30p',         'Bấm huyệt bàn chân thư giãn 30 phút',          100000, 30),
    ('MS-007', 'Massage chân phản xạ 45p',         'Bấm huyệt bàn chân thư giãn 45 phút',          150000, 45),
    ('MS-008', 'Massage chân phản xạ 60p',         'Bấm huyệt toàn bộ bàn chân 60 phút',           200000, 60),
    ('MS-009', 'Ngâm chân + Massage chân',         'Ngâm chân thảo dược + massage phản xạ 45p',    180000, 45),
    -- Massage đầu & vai gáy
    ('MS-010', 'Massage đầu 20p',                  'Massage đầu thư giãn giảm đau đầu 20 phút',     80000, 20),
    ('MS-011', 'Massage đầu & vai gáy 30p',        'Massage đầu kết hợp cổ vai gáy 30 phút',       120000, 30),
    ('MS-012', 'Massage đầu & vai gáy 45p',        'Massage đầu + cổ vai gáy + bắp tay 45 phút',   150000, 45),
    -- Massage lưng & cổ
    ('MS-013', 'Massage lưng 30p',                 'Massage vùng lưng giảm căng cơ 30 phút',        100000, 30),
    ('MS-014', 'Massage lưng & cổ 45p',            'Massage lưng + cổ + vai kết hợp 45 phút',      150000, 45),
    ('MS-015', 'Bấm huyệt lưng trị liệu',         'Bấm huyệt lưng hỗ trợ điều trị đau lưng',      200000, 45),
    -- Xông hơi & Ngâm
    ('MS-016', 'Xông hơi khô',                    'Xông hơi khô trong phòng sauna 30 phút',         80000, 30),
    ('MS-017', 'Xông hơi ướt',                    'Xông hơi ướt thảo dược 30 phút',                100000, 30),
    ('MS-018', 'Ngâm bồn thảo dược',              'Ngâm toàn thân bồn thảo dược thiên nhiên',      150000, 30),
    -- Combo
    ('MS-019', 'Combo Chân + Đầu vai',            'Massage chân phản xạ 45p + massage đầu vai',    250000, 75),
    ('MS-020', 'Combo Toàn thân + Chân',          'Massage toàn thân 60p + massage chân 30p',      350000, 90),
    ('MS-021', 'Combo Full Relax',                 'Xông hơi + massage toàn thân 90p + chân 30p',  550000, 120)
...
SELECT p.id, c.id
FROM (VALUES
    ('MS-001', 'Massage toàn thân'),
    ('MS-002', 'Massage toàn thân'),
    ('MS-003', 'Massage toàn thân'),
    ('MS-004', 'Massage toàn thân'),
    ('MS-005', 'Massage toàn thân'),
    ('MS-006', 'Massage chân phản xạ'),
    ('MS-007', 'Massage chân phản xạ'),
    ('MS-008', 'Massage chân phản xạ'),
    ('MS-009', 'Massage chân phản xạ'),
    ('MS-010', 'Massage đầu & vai gáy'),
    ('MS-011', 'Massage đầu & vai gáy'),
    ('MS-012', 'Massage đầu & vai gáy'),
    ('MS-013', 'Massage lưng & cổ'),
    ('MS-014', 'Massage lưng & cổ'),
    ('MS-015', 'Massage lưng & cổ'),
    ('MS-016', 'Xông hơi & Ngâm'),
    ('MS-017', 'Xông hơi & Ngâm'),
    ('MS-018', 'Xông hơi & Ngâm'),
    ('MS-019', 'Combo'),
    ('MS-020', 'Combo'),
    ('MS-021', 'Combo')
) AS pc(sku, cat_name)
